...
public class ApiFaceController extends BaseController {
    ...
    public ResponseData<FaceInfoModel> findImgBase64(String imgBase64) throws Exception {
...
//                    userAttendanceEntityWrapper.eq("")
    ...
    public ResponseData faceRegistered(String imgBase64,String name,String idCard){
        ResponseData responseData=new ResponseData();
        AipFace client = new AipFace(FaceUtil.APP_ID, FaceUtil.API_KEY, FaceUtil.SECRET_KEY);
        FaceUtil faceUtil = new FaceUtil();
        JSONObject jsonObject = faceUtil.userRegister(client, "{name:\""+name+"\",idCard:\""+idCard+"\",imgUrl:\"45314.jpg\" ,imgBase64:\""+imgBase64+"\"}", imgBase64, ShiroKit.getUser().getDeptId() + "", idCard);
