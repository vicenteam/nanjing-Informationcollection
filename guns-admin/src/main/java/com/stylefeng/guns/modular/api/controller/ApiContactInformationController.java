...
public class ApiContactInformationController extends BaseController {
   ...
   private IContactInformationService iContactInformationService;
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam( name = "contactInformationVolunteers3", value = "志愿者三"),
            @ApiImplicitParam( name = "contactInformationVolunteers3Phone", value = "志愿者三电话"),
            ...
            @ApiImplicitParam( name = "contactInformationContact3Name", value = "紧急联系人三 姓名"),
            @ApiImplicitParam( name = "contactInformationContact3Name", value = "急联系人三 姓名"),
            @ApiImplicitParam( name = "contactInformationContact3Relationship", value = "急联系人三 关系"),
            @ApiImplicitParam( name = "contactInformationContact3Sex", value = "急联系人三 性别"),
            @ApiImplicitParam( name = "contactInformationContact3Phone1", value = "急联系人三 电话"),
            @ApiImplicitParam( name = "contactInformationContact3Phone2", value = "急联系人三 备用电话"),
            @ApiImplicitParam( name = "contactInformationContact3Address", value = "急联系人三 地址"),
